...
const Leaderboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-300 to-white p-6 relative flex flex-col items-center">
      ...
      <div className="absolute top-4 right-4 bg-white border-2 border-gray-400 rounded-lg shadow-md px-4 py-2 text-sm text-gray-800">
        <p className="font-semibold">{mine?.name}</p>
        <p className="text-gray-600">Points: {mine?.point}</p>
      </div>
